...
- 项目边界：`../.claude_introduction/项目边界/项目边界.md`
  - 记录项目设计边界：哪些属于当前项目、哪些不属于、哪些能做、哪些不能做，以及成功标准、质量底线。
...
- 查询项目背景、项目边界、项目目标、环境、数据流、TODO 或其他 `.claude_introduction/` 事实文档时，优先使用 `query-project` skill。
...
- 需要判断项目设计边界（哪些能做、哪些不能做）、优先级或验收标准时，读取 `.claude_introduction/项目边界/`。
