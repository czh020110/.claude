...
- 项目内部背景、Boundary、Target、环境、长期进度等文档细节，不属于 `docs-research` agent 范围；这类问题应直接按 `.project-memory/` 索引读取对应正文。
...
- 当需要了解当前项目自身的背景、Boundary、Target、环境、长期进度等文档细节时，直接读取 `.project-memory/` 对应正文文件。
