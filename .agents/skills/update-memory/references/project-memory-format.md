...
同一事实只保留一个权威归属，其他主题用链接引用。新事实归入对应主题，不按时间追加到 `Target`，不写未实施方案、待定决策、用户未落地的修改要求、教程、候选方案或修改历史。
...
- `TODO/STEP.md`、`TODO/TODO.md` 和 `TODO/Pending.md` 不由本规范的实时记忆更新流程维护；`.project-script/` 也不属于项目记忆正文或索引。
